...
CuboidMaker.prototype.volume = function(){
  const cuboiVolume = this.length * this.width * this.height;
  return cuboiVolume;
}
...
CuboidMaker.prototype.surfaceArea = function(){
  const cuboiSurfaceArea = 2 * ((this.length * this.width) + (this.length * this.height) + (this.width * this.height));
  return cuboiSurfaceArea;
}
